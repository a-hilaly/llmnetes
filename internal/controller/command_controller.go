...
//+kubebuilder:rbac:groups=llmnetes.dev,resources=commands,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=llmnetes.dev,resources=commands/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=llmnetes.dev,resources=commands/finalizers,verbs=update
